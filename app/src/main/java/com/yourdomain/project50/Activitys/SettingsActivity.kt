...
class SettingsActivity : AppCompatActivity(), SecondsPickerFragment.OnSecondsPickerListener, WatingCountDownSecondsPicker.OnWattingCountDownSecondPickerListener {
    ...
    private fun onClicks() {
        ...
        btSHare.setOnClickListener { Utils.shareTextIntent(this@SettingsActivity, "I have just completed Day "+MY_Shared_PREF.getLastCompledDay(application) +" of "+ getString(R.string.app_name) + ". Join me: https://play.google.com/store/apps/details?id=" + application.packageName) }
